...
| 2026-07-05 | Bot B (sgkar) | Design decision: self-reported flashcards → add objectively-graded **Quiz mode** as primary (feeds fingerprint), demote flashcards to secondary practice-only (never logged). Full ready-to-build spec: **`QUIZ_MODE_BUILD.md`**. Not built yet — next session starts here. | ⏳ planned, not built |
